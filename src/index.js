...
whenever any state of this object changes then react will get a new REACT ELEMNT then react will compare this with the previous one and findout the changes and reach it to actual dom and update it accordingly.*/
    ...
    {/* <Conditional/> */}
    <App/>
    </>,document.getElementById("root"))//to render the react elemnt in the actual dom ReactDOM is used."elm"[it is the react elemnt which is to be rendered,"document.getElemntbyID("root")"this specifies where this reactelemnt is to be rendered in the realDOM ]